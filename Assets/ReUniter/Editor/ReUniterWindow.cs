...
# else
        ...
        public void OnEnable()
        {
            ...
            richTextGuiStyle = new GUIStyle { richText = true, fontSize = 12, margin = new RectOffset(5, 5, 5, 5), normal = { textColor = EditorStyles.label.normal.textColor } }; 
            rightAlignRichTextGuiStyle = new GUIStyle { richText = true, fontSize = 12, margin = new RectOffset(5,5,5,5), 
            alignment = TextAnchor.MiddleRight, normal = {textColor = new Color(.4f,.4f,.4f)}};
            centeredLabelStyle = new GUIStyle(EditorStyles.label) { alignment = TextAnchor.UpperCenter, wordWrap = true };
